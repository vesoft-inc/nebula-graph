...
TEST_F(DataCollectTest, CollectSubgraph) {
    auto* dc =
        DataCollect::make(qctx_.get(), DataCollect::CollectKind::kSubgraph, {"input_datasets"});
...
TEST_F(DataCollectTest, RowBasedMove) {
    auto* dc = DataCollect::make(
        qctx_.get(), DataCollect::CollectKind::kRowBasedMove, {"input_sequential"});
...
TEST_F(DataCollectTest, EmptyResult) {
    auto* dc = DataCollect::make(
        qctx_.get(), DataCollect::CollectKind::kSubgraph, {"empty_get_neighbors"});
    dc->setColNames(std::vector<std::string>{"_vertices", "_edges"});
