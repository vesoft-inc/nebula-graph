...
#define CHECK_LEXICAL_ERROR(STR)                                            \
    ...
    std::vector<Validator> validators = {
        ...
        CHECK_SEMANTIC_TYPE("Into", TokenType::KW_INTO),
        CHECK_SEMANTIC_TYPE("into", TokenType::KW_INTO),
        CHECK_SEMANTIC_TYPE("LISTENER", TokenType::KW_LISTENER),
        CHECK_SEMANTIC_TYPE("Listener", TokenType::KW_LISTENER),
        CHECK_SEMANTIC_TYPE("listener", TokenType::KW_LISTENER),
        CHECK_SEMANTIC_TYPE("LISTENERS", TokenType::KW_LISTENERS),
        CHECK_SEMANTIC_TYPE("Listeners", TokenType::KW_LISTENERS),
        CHECK_SEMANTIC_TYPE("listeners", TokenType::KW_LISTENERS),
        CHECK_SEMANTIC_TYPE("SERVICE", TokenType::KW_SERVICE),
        CHECK_SEMANTIC_TYPE("Service", TokenType::KW_SERVICE),
        CHECK_SEMANTIC_TYPE("service", TokenType::KW_SERVICE),
        CHECK_SEMANTIC_TYPE("SERVICES", TokenType::KW_SERVICES),
        CHECK_SEMANTIC_TYPE("Services", TokenType::KW_SERVICES),
        CHECK_SEMANTIC_TYPE("services", TokenType::KW_SERVICES),
        CHECK_SEMANTIC_TYPE("ELASTICSEARCH", TokenType::KW_ELASTICSEARCH),
        CHECK_SEMANTIC_TYPE("Elasticsearch", TokenType::KW_ELASTICSEARCH),
        CHECK_SEMANTIC_TYPE("elasticsearch", TokenType::KW_ELASTICSEARCH),
        CHECK_SEMANTIC_TYPE("KAFKA", TokenType::KW_KAFKA),
        CHECK_SEMANTIC_TYPE("Kafka", TokenType::KW_KAFKA),
        CHECK_SEMANTIC_TYPE("kafka", TokenType::KW_KAFKA),
        CHECK_SEMANTIC_TYPE("FULLTEXT", TokenType::KW_FULLTEXT),
        CHECK_SEMANTIC_TYPE("Fulltext", TokenType::KW_FULLTEXT),
        CHECK_SEMANTIC_TYPE("fulltext", TokenType::KW_FULLTEXT),
        CHECK_SEMANTIC_TYPE("STREAMING", TokenType::KW_STREAMING),
        CHECK_SEMANTIC_TYPE("Streaming", TokenType::KW_STREAMING),
        CHECK_SEMANTIC_TYPE("streaming", TokenType::KW_STREAMING),
