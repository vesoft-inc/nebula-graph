...
#define CHECK_LEXICAL_ERROR(STR)                                            \
    ...
    std::vector<Validator> validators = {
        ...
        CHECK_SEMANTIC_TYPE("Dba", TokenType::KW_DBA),
        CHECK_SEMANTIC_TYPE("dba", TokenType::KW_DBA),
        CHECK_SEMANTIC_TYPE("LDAP", TokenType::KW_LDAP),
        CHECK_SEMANTIC_TYPE("Ldap", TokenType::KW_LDAP),
        CHECK_SEMANTIC_TYPE("ldap", TokenType::KW_LDAP),
        ...
        CHECK_SEMANTIC_TYPE("MAX_Queries_Per_Hour", TokenType::KW_MAX_QUERIES_PER_HOUR),
        CHECK_SEMANTIC_TYPE("max_queries_per_hour", TokenType::KW_MAX_QUERIES_PER_HOUR),
        CHECK_SEMANTIC_TYPE("MAX_UPDATES_PER_HOUR", TokenType::KW_MAX_UPDATES_PER_HOUR),
        CHECK_SEMANTIC_TYPE("Max_updates_per_hour", TokenType::KW_MAX_UPDATES_PER_HOUR),
        CHECK_SEMANTIC_TYPE("MAX_Updates_per_hour", TokenType::KW_MAX_UPDATES_PER_HOUR),
        CHECK_SEMANTIC_TYPE("MAX_Updates_Per_Hour", TokenType::KW_MAX_UPDATES_PER_HOUR),
        CHECK_SEMANTIC_TYPE("max_updates_per_hour", TokenType::KW_MAX_UPDATES_PER_HOUR),
        CHECK_SEMANTIC_TYPE("MAX_CONNECTIONS_PER_HOUR", TokenType::KW_MAX_CONNECTIONS_PER_HOUR),
        CHECK_SEMANTIC_TYPE("MAX_connections_per_hour", TokenType::KW_MAX_CONNECTIONS_PER_HOUR),
        CHECK_SEMANTIC_TYPE("MAX_Connections_per_hour", TokenType::KW_MAX_CONNECTIONS_PER_HOUR),
        CHECK_SEMANTIC_TYPE("MAX_Connections_Per_Hour", TokenType::KW_MAX_CONNECTIONS_PER_HOUR),
        CHECK_SEMANTIC_TYPE("max_connections_per_hour", TokenType::KW_MAX_CONNECTIONS_PER_HOUR),
        CHECK_SEMANTIC_TYPE("MAX_USER_CONNECTIONS", TokenType::KW_MAX_USER_CONNECTIONS),
        CHECK_SEMANTIC_TYPE("Max_user_connections", TokenType::KW_MAX_USER_CONNECTIONS),
        CHECK_SEMANTIC_TYPE("MAX_User_connections", TokenType::KW_MAX_USER_CONNECTIONS),
        CHECK_SEMANTIC_TYPE("MAX_User_Connections", TokenType::KW_MAX_USER_CONNECTIONS),
        CHECK_SEMANTIC_TYPE("max_user_connections", TokenType::KW_MAX_USER_CONNECTIONS),
