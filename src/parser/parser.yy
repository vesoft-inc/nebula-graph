...
%union {
    ...
    nebula::ServiceClients                 *service_client_list;
...
%token KW_LISTENER KW_LISTENERS KW_ELASTICSEARCH KW_FULLTEXT KW_KAFKA KW_STREAMING
%token KW_AUTO KW_FUZZY KW_PREFIX KW_REGEXP KW_WILDCARD
%token KW_TEXT KW_SEARCH KW_SIGN KW_SERVICE KW_SERVICES KW_TEXT_SEARCH
...
%type <sentence> sign_in_streaming_service_sentence sign_out_streaming_service_sentence
%type <sentence> show_text_search_service_sentence show_streaming_service_sentence
...
unreserved_keyword
    ...
    | KW_LISTENERS          { $$ = new std::string("listeners"); }
    ...
    | KW_SERVICES           { $$ = new std::string("services"); }
    ...
    | KW_STREAMING          { $$ = new std::string("streaming"); }
    ;
...
sign_in_streaming_service_sentence
    : KW_SIGN KW_IN KW_STREAMING KW_SERVICE service_client_list {
        $$ = new SignInStreamingServiceSentence($5);
    }
    ;

show_text_search_service_sentence
    : KW_SHOW KW_TEXT KW_SERVICES {
        $$ = new ShowTextServicesSentence();
    }

show_streaming_service_sentence
    : KW_SHOW KW_STREAMING KW_SERVICES {
        $$ = new ShowStreamingServicesSentence();
    }
...
sign_out_streaming_service_sentence
    : KW_SIGN KW_OUT KW_STREAMING KW_SERVICE {
        $$ = new SignOutStreamingServiceSentence();
    }
    ;
...
list_listener_sentence
    : KW_SHOW KW_LISTENERS {
        $$ = new ShowListenersSentence();
    }
    ;
...
maintain_sentence
    ...
    | sign_in_streaming_service_sentence { $$ = $1; }
    | sign_out_streaming_service_sentence { $$ = $1; }
    | show_text_search_service_sentence { $$ = $1; }
    | show_streaming_service_sentence { $$ = $1; }
    ;
