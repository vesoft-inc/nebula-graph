...
public:
    explicit DeleteVerticesSentence(VertexIDList *vidList) : Sentence(Kind::kDeleteVertices),
                                                             vClause_(new VerticesClause(vidList)) {
    }

    explicit DeleteVerticesSentence(Expression *ref) : Sentence(Kind::kDeleteVertices),
