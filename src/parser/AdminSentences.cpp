...
std::string ShowListenersSentence::toString() const {
    return "SHOW LISTENERS";
}
...
std::string ShowTextServicesSentence::toString() const {
    return "SHOW TEXT SERVICES";
}

std::string ShowStreamingServicesSentence::toString() const {
    return "SHOW STREAMING SERVICES";
}
