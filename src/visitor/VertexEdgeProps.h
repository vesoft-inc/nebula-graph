...
#ifndef VISITOR_VERTEXEDGEPROPS_H_
#define VISITOR_VERTEXEDGEPROPS_H_
...
public:
    ...
    VertexEdgeProps(std::set<std::string> paths,
...
#endif  // VISITOR_VERTEXEDGEPROPS_H_
