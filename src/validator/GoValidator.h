...
private:
    ...
    VertexPropsPtr buildSrcVertexProps();

    VertexPropsPtr buildDstVertexProps();

    EdgePropsPtr buildEdgeProps();

    EdgePropsPtr buildEdgeDst();

    void buildEdgeProps(EdgePropsPtr& edgeProps, bool isInEdge);
