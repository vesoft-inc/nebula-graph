...
TEST_F(FindPathValidatorTest, SinglePairPath) {
    {
        std::string query =
            "FIND SHORTEST PATH WITH PROP FROM \"1\" TO \"2\" OVER like UPTO 5 STEPS";
...
TEST_F(FindPathValidatorTest, ALLPath) {
    {
        std::string query = "FIND ALL PATH WITH PROP FROM \"1\" TO \"2\" OVER like UPTO 5 STEPS";
        std::vector<PlanNode::Kind> expected = {
            PK::kDataCollect,
            PK::kGetEdges,
            PK::kGetVertices,
    ...
    {
        std::string query =
            "FIND ALL PATH WITH PROP FROM \"1\" TO \"2\",\"3\" OVER like UPTO 5 STEPS";
        std::vector<PlanNode::Kind> expected = {
            PK::kDataCollect,
            PK::kGetEdges,
            PK::kGetVertices,
...
TEST_F(FindPathValidatorTest, RunTimePath) {
    {
        std::string query =
            ...
            " | FIND SHORTEST PATH WITH PROP FROM $-.src TO $-.dst OVER like, serve UPTO 5 STEPS";
        std::vector<PlanNode::Kind> expected = {
            PK::kDataCollect,
            PK::kGetEdges,
            PK::kGetVertices,
    ...
    }
    {
        std::string query =
            "GO FROM \"1\" OVER like YIELD like._src AS src, like._dst AS dst "
            " | FIND ALL PATH WITH PROP FROM $-.src TO $-.dst OVER like, serve UPTO 5 STEPS";
        std::vector<PlanNode::Kind> expected = {
            PK::kDataCollect,
            PK::kGetEdges,
            PK::kGetVertices,
    ...
    }
    {
        std::string query =
            "GO FROM \"1\" OVER like YIELD like._src AS src, like._dst AS dst "
            " | FIND SHORTEST PATH WITH PROP FROM $-.src TO \"2\" OVER like, serve UPTO 5 STEPS";
        std::vector<PlanNode::Kind> expected = {
            PK::kDataCollect,
            PK::kGetEdges,
            PK::kGetVertices,
