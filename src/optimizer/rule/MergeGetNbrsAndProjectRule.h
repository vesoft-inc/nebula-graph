...
#ifndef OPTIMIZER_RULE_MERGEGETNBRSANDPROJECTRULE_H_
#define OPTIMIZER_RULE_MERGEGETNBRSANDPROJECTRULE_H_
...
#endif   // OPTIMIZER_RULE_MERGEGETNBRSANDPROJECTRULE_H_
