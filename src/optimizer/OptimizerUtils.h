...
public:
    ...
    //     * process collected column hints, for example, merge the begin and end values of range
    //     scan
    ...
    //     * find the first not prefix column hint and ignore all followed hints except first range
    //     hint
