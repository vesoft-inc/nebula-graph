...
#ifndef PLANNER_PLANNERS_MATCH_CYPHERCLAUSEPLANNER_H_
#define PLANNER_PLANNERS_MATCH_CYPHERCLAUSEPLANNER_H_
...
#endif  // PLANNER_PLANNERS_MATCH_CYPHERCLAUSEPLANNER_H_
