...
public:
    CreateSnapshotExecutor(const PlanNode *node, ExecutionContext *ectx)
...
public:
    DropSnapshotExecutor(const PlanNode *node, ExecutionContext *ectx)
...
public:
    ShowSnapshotsExecutor(const PlanNode *node, ExecutionContext *ectx)
