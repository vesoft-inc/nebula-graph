...
TEST_F(AggregateTest, CountDistinct) {
    {
        ...
        TEST_AGG_1(AggFun::Function::kCountDist, "count_dist", false)
    }
    {
        // ===============
        // | count_dist  |
        ...
        TEST_AGG_2(AggFun::Function::kCountDist, "count_dist", false)
    }
    {
        // =======================
        // | col2 | count_dist   |
        ...
        TEST_AGG_3(AggFun::Function::kCountDist, "count_dist", false)
    }
    {
        // ===============
        // | count_dist  |
        ...
        // key =
        // items = count_dist(1)
        TEST_AGG_4(AggFun::Function::kCountDist, "count_dist", false)
    }
}
