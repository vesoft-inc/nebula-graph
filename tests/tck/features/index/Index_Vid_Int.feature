Feature: IndexTest_Vid_String
  ...
  Scenario: IndexTest TagIndex
    ...
    And having executed:
      ...
      CREATE SPACE tag_index_space1(partition_num=1, replica_factor=1,vid_type = int64);
  ...
  Scenario: IndexTest EdgeIndex
    ...
    And having executed:
      ...
      CREATE SPACE edge_index_space1(partition_num=1, replica_factor=1,vid_type = int64);
  ...
  Scenario: IndexTest TagIndexTTL
    ...
    And having executed:
      ...
      CREATE SPACE tag_ttl_index_space1(partition_num=1, replica_factor=1,vid_type = int64);
  ...
  Scenario: IndexTest EdgeIndexTTL
    ...
    And having executed:
      ...
      CREATE SPACE edge_ttl_index_space1(partition_num=1, replica_factor=1,vid_type = int64);
  ...
  Scenario: IndexTest RebuildTagIndexStatusInfo
    ...
    And having executed:
      ...
      CREATE SPACE tag_status_space1(partition_num=1, replica_factor=1,vid_type = int64);
  ...
  Scenario: IndexTest RebuildEdgeIndexStatusInfo
    ...
    And having executed:
      ...
      CREATE SPACE edge_status_space1(partition_num=1, replica_factor=1,vid_type = int64);
  ...
  Scenario: IndexTest AlterSchemaTest
    ...
    And having executed:
      ...
      CREATE SPACE alter_space1(partition_num=1, replica_factor=1,vid_type = int64);
      USE alter_space1;
