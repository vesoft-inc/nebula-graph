...
Feature: NULL related operations
  ...
  Scenario: NULL with math functions 
    ...
    Then the result should be, in any order:
      | value1   | value2   | value3   | value4   | value5   |
      | __NULL__ | __NULL__ | __NULL__ | __NULL__ | __NULL__ |
    When executing query:
      """
    ...
    Then the result should be, in any order:
      | value1   | value2   | value3   | value4   | value5   |
      | __NULL__ | BAD_TYPE | BAD_TYPE | __NULL__ | __NULL__ |
    When executing query:
      """
    ...
    Then the result should be, in any order:
      | value1   | value2   | value3   | value4   | value5   |
      | __NULL__ | __NULL__ | __NULL__ | __NULL__ | BAD_TYPE |
    When executing query:
      """
    ...
    Then the result should be, in any order:
      | value1   | value2   | value3 | value4   | value5   |
      | __NULL__ | __NULL__ | 0      | __NULL__ | __NULL__ |
    When executing query:
      """
