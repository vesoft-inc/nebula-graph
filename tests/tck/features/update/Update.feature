...
Feature: Update string vid of vertex and edge
  ...
  Scenario: update and upsert test with 1.0 syntax
    ...
    # filter condition is always true, insert default value or update value, TODO:FIXED, now is failed
    # When executing query:
    # """
    # UPSERT EDGE "601" -> "101"@0 OF select_default
    ...
    # When executing query:
    # """
    # UPSERT EDGE ON select_default "222" ->UPDATE VERTEX ON course "101" "333"@0
