...
Feature: Test get subgraph before pipe
  ...
  Scenario: two steps subgraph with limit
    ...
    Then define some list variables:
      ...
      | [:serve "Tim Duncan"->"Spurs"@0]                | ("Aron Baynes")       | [:serve "Boris Diaw"->"Hawks" @0 ]                 |
      | [:teammate "Tim Duncan"->"Danny Green"@0]       | ("Boris Diaw")        | [:serve "Boris Diaw"->"Hornets" @0 ]               |
      | [:teammate "Tim Duncan"->"LaMarcus Aldridge"@0] | ("Shaquile O\'Neal")  | [:serve "Boris Diaw"->"Jazz" @0 ]                  |
      | [:teammate "Tim Duncan"->"Manu Ginobili"@0]     | ("Tony Parker")       | [:serve "Boris Diaw"->"Spurs" @0 ]                 |
      | [:teammate "Tim Duncan"->"Tony Parker"@0]       | ("Spurs")             | [:serve "Boris Diaw"->"Suns" @0 ]                  |
      |                                                 | ("Dejounte Murray")   | [:like "Manu Ginobili"->"Tim Duncan" @0 ]          |
      |                                                 | ("LaMarcus Aldridge") | [:serve "Manu Ginobili"->"Spurs" @0 ]              |
      |                                                 | ("Marco Belinelli")   | [:teammate "Manu Ginobili"->"Tim Duncan" @0 ]      |
      |                                                 | ("Tiago Splitter")    | [:teammate "Manu Ginobili"->"Tony Parker" @0 ]     |
  ...
  Scenario: three steps subgraph with property + direction + limit
    ...
    Then define some list variables:
      | edge1                                          | edge2                                           |
      | [:serve "Paul George"->"Pacers" @0 ]           | [:serve "Russell Westbrook"->"Thunders" @0 ]    |
      | [:serve "Paul George"->"Thunders" @0 ]         | [:like "Russell Westbrook"->"James Harden" @0 ] |
      | [:like "Paul George"->"Russell Westbrook" @0 ] | [:like "Russell Westbrook"->"Paul George" @0 ]  |
    Then the result should be, in any order, with relax comparison:
      | _vertices                                         | _edges    |
      | [("Paul George")]                                 | <[edge1]> |
