...
Feature: subgraph
  ...
  Scenario: many steps
    ...
    When executing query:
      """
      Get Subgraph 4 steps from 'Tim Duncan' BOTH like
      """
    Then define some list variables:
      | edge1                                       | vertex2               | edge2                                            | vertex3               | edge3                                         | vertex4             | edge4                                         | vertex5                | edge5                                            |
      | [:like "Aron Baynes"->"Tim Duncan"@0]       | ("Manu Ginobili")     | [:like "Dejounte Murray"->"Manu Ginobili"@0]     | ("Chris Paul")        | [:like "Blake Griffin"->"Chris Paul"@0]       | ("Tracy McGrady")   | [:like "Grant Hill"->"Tracy McGrady"@0]       | ("Grant Hill")         | [:teammate "Tim Duncan"->"Danny Green"@0]        |
      | [:like "Boris Diaw"->"Tim Duncan"@0]        | ("LaMarcus Aldridge") | [:like "Tiago Splitter"->"Manu Ginobili"@0]      | ("Kyle Anderson")     | [:like "Carmelo Anthony"->"Chris Paul"@0]     | ("Carmelo Anthony") | [:like "Vince Carter"->"Tracy McGrady"@0]     | ("Dirk Nowitzki")      | [:teammate "Tim Duncan"->"LaMarcus Aldridge"@0]  |
      | [:like "Danny Green"->"Tim Duncan"@0]       | ("Danny Green")       | [:like "Tony Parker"->"Manu Ginobili"@0]         | ("LeBron James")      | [:like "Dwyane Wade"->"Chris Paul"@0]         | ("Blake Griffin")   | [:like "Tracy McGrady"->"Grant Hill"@0]       | ("Kobe Bryant")        | [:teammate "Tim Duncan"->"Manu Ginobili"@0]      |
      | [:like "Dejounte Murray"->"Tim Duncan"@0]   | ("Dejounte Murray")   | [:like "Damian Lillard"->"LaMarcus Aldridge"@0]  | ("JaVale McGee")      | [:like "Chris Paul"->"Carmelo Anthony"@0]     | ("Dwyane Wade")     | [:like "Tracy McGrady"->"Kobe Bryant"@0]      | ("Kristaps Porzingis") | [:teammate "Tim Duncan"->"Tony Parker"@0]        |
      | [:like "LaMarcus Aldridge"->"Tim Duncan"@0] | ("Aron Baynes")       | [:like "Rudy Gay"->"LaMarcus Aldridge"@0]        | ("Yao Ming")          | [:like "Chris Paul"->"Dwyane Wade"@0]         | ("Luka Doncic")     | [:like "Dwyane Wade"->"Carmelo Anthony"@0]    | ("Vince Carter")       | [:teammate "Manu Ginobili"->"Tim Duncan"@0]      |
      | [:like "Manu Ginobili"->"Tim Duncan"@0]     | ("Boris Diaw")        | [:like "Tony Parker"->"LaMarcus Aldridge"@0]     | ("Rudy Gay")          | [:like "Chris Paul"->"LeBron James"@0]        | ("Paul George")     | [:like "Carmelo Anthony"->"Dwyane Wade"@0]    | ("Rajon Rondo")        | [:teammate "Tony Parker"->"Tim Duncan"@0]        |
      | [:like "Marco Belinelli"->"Tim Duncan"@0]   | ("Tiago Splitter")    | [:like "LaMarcus Aldridge"->"Tony Parker"@0]     | ("Damian Lillard")    | [:like "Carmelo Anthony"->"LeBron James"@0]   | ("Ray Allen")       | [:like "Dirk Nowitzki"->"Dwyane Wade"@0]      |                        | [:teammate "Tony Parker"->"LaMarcus Aldridge"@0] |
      | [:like "Shaquile O'Neal"->"Tim Duncan"@0]   | ("Marco Belinelli")   | [:like "Dejounte Murray"->"Danny Green"@0]       | ("Russell Westbrook") | [:like "Dwyane Wade"->"LeBron James"@0]       | ("Kyrie Irving")    | [:like "Kristaps Porzingis"->"Luka Doncic"@0] |                        | [:teammate "Tony Parker"->"Kyle Anderson"@0]     |
      | [:like "Tiago Splitter"->"Tim Duncan"@0]    | ("Shaquile O'Neal")   | [:like "Marco Belinelli"->"Danny Green"@0]       | ("James Harden")      | [:like "Kyrie Irving"->"LeBron James"@0]      |                     | [:like "Luka Doncic"->"Dirk Nowitzki"@0]      |                        | [:teammate "Manu Ginobili"->"Tony Parker"@0]     |
      | [:like "Tony Parker"->"Tim Duncan"@0]       | ("Tony Parker")       | [:like "Danny Green"->"LeBron James"@0]          | ("Kevin Durant")      | [:like "LeBron James"->"Ray Allen"@0]         |                     | [:like "Luka Doncic"->"Kristaps Porzingis"@0] |                        | [:teammate "Tony Parker"->"Manu Ginobili"@0]     |
      | [:like "Tim Duncan"->"Manu Ginobili"@0]     |                       | [:like "Danny Green"->"Marco Belinelli"@0]       |                       | [:like "Yao Ming"->"Tracy McGrady"@0]         |                     | [:like "Rajon Rondo"->"Ray Allen"@0]          |                        |                                                  |
      | [:like "Tim Duncan"->"Tony Parker"@0]       |                       | [:like "Dejounte Murray"->"Chris Paul"@0]        |                       | [:like "Tracy McGrady"->"Rudy Gay"@0]         |                     | [:like "Ray Allen"->"Rajon Rondo"@0]          |                        |                                                  |
      |                                             |                       | [:like "Dejounte Murray"->"James Harden"@0]      |                       | [:like "James Harden"->"Russell Westbrook"@0] |                     |                                               |                        |                                                  |
      |                                             |                       | [:like "Dejounte Murray"->"Kevin Durant"@0]      |                       | [:like "Paul George"->"Russell Westbrook"@0]  |                     |                                               |                        |                                                  |
      |                                             |                       | [:like "Dejounte Murray"->"Kyle Anderson"@0]     |                       | [:like "Russell Westbrook"->"James Harden"@0] |                     |                                               |                        |                                                  |
      |                                             |                       | [:like "Dejounte Murray"->"LeBron James"@0]      |                       | [:like "Russell Westbrook"->"Paul George"@0]  |                     |                                               |                        |                                                  |
      |                                             |                       | [:like "Dejounte Murray"->"Marco Belinelli"@0]   |                       | [:like "Luka Doncic"->"James Harden"@0]       |                     |                                               |                        |                                                  |
      |                                             |                       | [:like "Dejounte Murray"->"Russell Westbrook"@0] |                       |                                               |                     |                                               |                        |                                                  |
      |                                             |                       | [:like "Dejounte Murray"->"Tony Parker"@0]       |                       |                                               |                     |                                               |                        |                                                  |
      |                                             |                       | [:like "Boris Diaw"->"Tony Parker"@0]            |                       |                                               |                     |                                               |                        |                                                  |
      |                                             |                       | [:like "Marco Belinelli"->"Tony Parker"@0]       |                       |                                               |                     |                                               |                        |                                                  |
