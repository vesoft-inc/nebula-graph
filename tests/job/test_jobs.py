...
class TestJobs(NebulaTestSuite):
    ...
    def test_succeeded(self):
        ...
        self.check_column_names(resp, expect_col_names)
        expect_values = [[re.compile(r'\d+'), re.compile(r'COMPACT'), re.compile(r'\S+'), re.compile(r'.*'), re.compile(r'.*')],
                         [re.compile(r'\d+'), re.compile(r'FLUSH'), re.compile(r'\S+'), re.compile(r'.*'), re.compile(r'.*')],
                         [re.compile(r'\d+'), re.compile(r'STATS'), re.compile(r'\S+'), re.compile(r'.*'), re.compile(r'.*')]]
