...
class TestSchema(NebulaTestSuite):
    ...
    def test_alter_edge_with_timestamp_default(self):
        resp = self.client.execute('CREATE SPACE IF NOT EXISTS issue2009(vid_type = FIXED_STRING(20)); USE issue2009')
        self.check_resp_succeeded(resp)
    ...
    def test_create_tag_with_null_default_value(self):
        resp = self.client.execute('CREATE TAG IF NOT EXISTS tag_null_default1(name string NULL DEFAULT "N/A")')
        self.check_resp_succeeded(resp)
        ...
        resp = self.client.execute('CREATE TAG IF NOT EXISTS tag_null_default2(name string DEFAULT "N/A" NULL)')
        self.check_resp_succeeded(resp)
    ...
    def test_create_tag_with_not_null_default_value(self):
        resp = self.client.execute('CREATE TAG IF NOT EXISTS tag_not_null_default1(name string NOT NULL DEFAULT "N/A")')
        self.check_resp_succeeded(resp)
        ...
        resp = self.client.execute('CREATE TAG IF NOT EXISTS tag_not_null_default2(name string DEFAULT "N/A" NOT NULL)')
        self.check_resp_succeeded(resp)
    ...
    def test_with_bad_null_default_value(self):
        # failed
        resp = self.execute('CREATE TAG IF NOT EXISTS bad_null_default_value(name string DEFAULT "N/A", age int DEFAULT 1%0)')
        self.check_resp_failed(resp)
